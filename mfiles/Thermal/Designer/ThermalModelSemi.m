...
%             obj.heatsink = liquidPinSubstModel(200, 0.005, 0.006, 0.010, 0.001);
%             obj.heatsink.defineFluidProperties(7/1000/60, 1000, 3.4);
...
%             [hInf, rThSpread, rThTotal] = obj.heatsink.thermalResistanceCalc(39*10^-6,39*10^-6);
