...
RthSim1 = (118.04-65)/40;
plot([0 1000], [RthSim1 RthSim1], '-.')
RthSim2 = (127.1-65)/40;
% plot([0 1000], [RthSim2 RthSim2], '-.')
line([areaCopper1_Eff*10^6 areaCopper1_Eff*10^6], [-10 10])
line([areaIGBT*10^6 areaIGBT*10^6], [-10 10])
line([2*areaIGBT*10^6 2*areaIGBT*10^6], [-10 10])
